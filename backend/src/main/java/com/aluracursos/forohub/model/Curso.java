...
public class Curso {
    ...
    public Curso(DatosRegistroCurso registroCurso){
        ...
        this.descripcion = registroCurso.descripcion();
        this.tags = registroCurso.tags();
        this.status = true;
    }
    ...
    public void actualizarDatos(DatosActualizarCurso datos) {
        ...
        if (datos.categoriaPrincipal() != null) {
            this.categoriaPrincipal = datos.categoriaPrincipal();
        }
        if (datos.subcategoria() != null) {
