...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.cors(cors -> {}) // Habilitar CORS en la seguridad
                ...
                .requestMatchers("/ws/**").permitAll() // Permitir WebSocket handshake
                .requestMatchers("/", "/index.html", "/assets/**", "/favicon.ico", "/css/**", "/js/**", "/img/**").permitAll() // Recursos estáticos
